...
export default function QuotePage() {
  ...
  useEffect(() => {
    ...
    if (svc) {
      // map free text to a known service (very simple mapping for now)
  ...
  function onSubmit(e) {
    ...
    setShowResult(true);
    // TODO: send to CRM (Airtable/Sheets) and WhatsApp
  }
    ...
    <main className="min-h-screen bg-white">
      <section className="mx-auto max-w-3xl px-6 py-10">
        ...
        <form onSubmit={onSubmit} className="mt-8 space-y-6">
          ...
          <button type="submit" className="w-full sm:w-auto rounded-xl bg-teal-500 text-white px-5 py-3 font-semibold hover:bg-teal-600">
            Get My Estimate
          </button>
        </form>
