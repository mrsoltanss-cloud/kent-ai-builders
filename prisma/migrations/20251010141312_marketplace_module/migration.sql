...
/*
  ...
  - You are about to drop the column `photos` on the `Lead` table. All the data in the column will be lost.
...
-- CreateEnum
CREATE TYPE "JobTier" AS ENUM ('STANDARD', 'QUICKWIN', 'PRIORITY');
...
ALTER TYPE "Urgency" ADD VALUE 'ASAP';
ALTER TYPE "Urgency" ADD VALUE 'THIS_MONTH';
...
DROP COLUMN "notes",
DROP COLUMN "photos",
ADD COLUMN     "aiEstimateHigh" INTEGER,
ADD COLUMN     "aiEstimateLow" INTEGER,
...
CREATE TABLE "Job" (
    ...
    "contactUnlocks" INTEGER NOT NULL DEFAULT 0,
    "allocCap" INTEGER NOT NULL DEFAULT 3,
    "aiSeeded" BOOLEAN NOT NULL DEFAULT false,
...
-- CreateTable
CREATE TABLE "JobTradeTag" (
    "jobId" TEXT NOT NULL,
    "tradeId" TEXT NOT NULL,

    CONSTRAINT "JobTradeTag_pkey" PRIMARY KEY ("jobId","tradeId")
);

-- CreateTable
CREATE TABLE "JobIntro" (
    "id" TEXT NOT NULL,
    "jobId" TEXT NOT NULL,
    "builderId" TEXT,
    ...
    CONSTRAINT "JobIntro_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "TradeTag_key_key" ON "TradeTag"("key");

-- CreateIndex
CREATE UNIQUE INDEX "JobIntro_jobId_fingerprint_key" ON "JobIntro"("jobId", "fingerprint");
...
-- AddForeignKey
ALTER TABLE "JobTradeTag" ADD CONSTRAINT "JobTradeTag_jobId_fkey" FOREIGN KEY ("jobId") REFERENCES "Job"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "JobTradeTag" ADD CONSTRAINT "JobTradeTag_tradeId_fkey" FOREIGN KEY ("tradeId") REFERENCES "TradeTag"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "JobIntro" ADD CONSTRAINT "JobIntro_jobId_fkey" FOREIGN KEY ("jobId") REFERENCES "Job"("id") ON DELETE CASCADE ON UPDATE CASCADE;
