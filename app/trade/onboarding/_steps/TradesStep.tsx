  ...
  return (
    ...
    >
      ...
      <div className="flex justify-between items-center">
        <button onClick={onBack} className="text-sky-300 hover:text-sky-100 transition">← Back</button>
        <span className="text-sky-300 text-sm">{selected.length} selected</span>
      </div>
      ...
      <button
        ...
        onClick={() => router.push("/trade/onboarding/coverage")}
      >
        Continue →
      </button>
    </motion.div>
