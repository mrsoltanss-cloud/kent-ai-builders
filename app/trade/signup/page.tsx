          ...
          <Magnetic strength={0.08}>
            <Tilt max={12} className="rounded-3xl glass-card rim-gold px-4 sm:px-6 py-8 sm:p-12 text-center text-white">
              ...
              >
                ...
                <div className="mt-8">
                  <RippleButton
                    onClick={() => (window.location.href="/trade/onboarding/account")}
                    className="h-12 w-full sm:w-auto w-full rounded-xl bg-cyan-500 text-white hover:bg-cyan-600 transition-colors text-base font-semibold"
                  >
                    Continue with Email
                ...
                <p className="text-slate-300 text-sm mt-6">
                  Already a member?{" "}
                  <a href="/trade/onboarding/account" className="text-cyan-300 hover:underline">
                    Sign in
                  </a>
                </p>
...
// --- Added: trade sign-in helper (Sprint 2) ---
export function TradeSigninHelper() {
  return (
    <div className="mt-6 text-center">
      <span className="text-sm text-gray-600">Already a member? </span>
      <a href="/trade/signin" className="text-sm text-emerald-700 hover:underline">
        Sign in
      </a>
    </div>
  );
