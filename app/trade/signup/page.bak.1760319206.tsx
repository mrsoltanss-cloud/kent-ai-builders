          ...
          <Magnetic strength={0.08}>
            <Tilt max={12} className="rounded-3xl glass-card rim-gold px-4 sm:px-6 py-8 sm:p-12 text-center text-white">
              ...
              >
                ...
                <div className="mt-8">
                  <RippleButton
                    onClick={() => (window.location.href="/auth/signup?next=/trade/onboarding")}
                ...
                <p className="text-slate-300 text-sm mt-6">
                  Already a member?{" "}
                  <a href="/api/auth/signin?provider=email&callbackUrl=/trade/onboardingcallbackUrl=/trade/onboarding" className="text-cyan-300 hover:underline">
                    Sign in
                  </a>
                </p>
