      ...
      <div className="mx-auto max-w-3xl px-4 py-14">
        <div className="rounded-3xl border border-emerald-200/60 bg-white p-8 sm:p-12 shadow-sm">
          ...
          <div className="mt-8 grid gap-3 sm:grid-cols-2">
            <Link href="/my" className="inline-flex items-center justify-center rounded-xl bg-emerald-600 px-4 py-3 text-white hover:bg-emerald-700 focus:outline-none focus:ring-2 focus:ring-emerald-300">Back to my area</Link>
